...
server_parameters = StdioServerParameters(
    command="uv",
    args=["run", "mcp_doctor_server.py"],
    env=None,
)

@server.agent(metadata=Metadata(ui={"type": "hands-off", "user_greeting": "Ask the health agent anything about the hospital"}))
...
@server.agent(metadata=Metadata(ui={"type": "hands-off", "user_greeting": "Ask the doctor agent anything about doctors"}))
